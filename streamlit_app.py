...
st.set_page_config(page_title="Cement Plant EDA Chatbot", layout="wide")

st.title("⚡ Cement Plant Power Factor EDA + Chatbot")
st.write(
...
if uploaded_file is not None:
    try:
        ...
        if pf_below_08 is not None:
            st.metric("PF < 0.8 (%)", f"{pf_below_08:.2f}")
